...
def crash_log(candidate):
  ...
  control_keys, vehicle_keys, visual_keys = [
    ...
    "FireTheBabysitter", "NoLogging", "MuteOverheated", "OfflineMode", "LateralTune", "NNFF", "SteerRatio", "LongitudinalTune", "AccelerationProfile",
    "AggressiveAcceleration", "StoppingDistance", "SmoothBraking", "Model", "MTSCEnabled", "MTSCAggressiveness", "NudgelessLaneChange", "LaneChangeTime",
    "LaneDetection", "OneLaneChange", "QOLControls", "DisableOnroadUploads", "HigherBitrate", "NavChill", "PauseLateralOnSignal", "ReverseCruise",
    "ReverseCruiseUI", "SetSpeedOffset", "SpeedLimitController", "Offset1", "Offset2", "Offset3", "Offset4", "SLCFallback", "SLCPriority1", "SLCPriority2",
    "SLCPriority3", "SLCOverride", "TurnDesires", "VisionTurnControl", "CurveSensitivity", "TurnAggressiveness"
  ], [
