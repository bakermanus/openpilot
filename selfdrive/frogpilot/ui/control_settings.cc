...
FrogPilotControlsPanel::FrogPilotControlsPanel(SettingsWindow *parent) : FrogPilotListWidget(parent) {
  ...
  std::set<std::string> rebootKeys = {"AlwaysOnLateral", "FireTheBabysitter", "HigherBitrate", "NNFF", "OfflineMode"};
  ...
  fireTheBabysitterKeys = {"NoLogging", "MuteOverheated", "OfflineMode"};
  laneChangeKeys = {"LaneChangeTime", "LaneDetection", "OneLaneChange"};
  lateralTuneKeys = {"NNFF"};
  longitudinalTuneKeys = {"AccelerationProfile", "AggressiveAcceleration", "StoppingDistance"};
  mtscKeys = {"MTSCAggressiveness"};
  qolKeys = {"DisableOnroadUploads", "HigherBitrate", "NavChill", "PauseLateralOnSignal", "ReverseCruise"};
